...
/*
 * 用于向海关发送出口重箱抵港报文
 * 类型：Manifest_Arrival_Ship_Delete_3101_3
 */
...
class GenerateMAS3101Del extends GroovyApi {
    ...
    public String reason = 'Business Demand'
    public String contactName = 'GAO WEI'
...
//        }
        ...
        xmlBuilder.'Manifest'(
                ...
                'xsi:schemaLocation':'urn:Declaration:datamodel:standard:CN:MT3101:1 Manifest_Arrival_Ship_Delete_3101_3.xsd'
        )
                {
                    'Head'{
                        'MessageID'(messageId)
