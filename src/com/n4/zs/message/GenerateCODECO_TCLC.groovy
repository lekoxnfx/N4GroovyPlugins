...
class GenerateCODECO_TCLC extends GroovyApi{
	public String fileDir = "D:\\MESSAGE\\CODECO_TCLC"
	public String fileDirBak = "D:\\MESSAGE\\Backup\\CODECO_TCLC"
	...
	public String generateCodecoText(Unit unit){
		try{
			...
			switch(io){
				case "I": 				
				voyage = vslcv.getCarrierObVoyNbrOrTrainId()
				break
				case "O":
				voyage = vslcv.getCarrierIbVoyNbrOrTrainId()
				break
				default:
				throw new Exception("进出标志错误")
			}
			...
			String edi10="""
			10:${vessel_code}:${vessel}:${voyage}:TCLC:'
			"""
