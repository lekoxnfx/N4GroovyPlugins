...
class PhaseVV_COS {
    public void execute(GroovyEvent event, GroovyApi api){
        ...
        vvd.getVvdVvlineSet().each{l->
            ...
            if(vvdl.getVvlineBizu().getBzuId().equals("COS")){
                //触发COS装卸报文生成事件
                //卸船
                String postEventName1 = "VV_SEND_COS_COARRI_DISCHARGE" //要触发的事件名
                ...
                //装船
                String postEventName2 = "VV_SEND_COS_COARRI_LOAD" //要触发的事件名
